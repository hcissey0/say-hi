  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={handleClose}>
        ...
        <div className="fixed mx-auto w-1/2 inset-0 z-10 overflow-y-visible">
                ...
                <div>
                  <Switch.Group as="div" className="flex items-center my-5">
                    ...
                    <Switch
                      ...
                      className={classNames(
                        isGroupChat ? "bg-secondary" : "bg-secondary-200",
                        "relative outline outline-[1px] outline-secondary inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-0"
                      )}
                    >
                      <span
                        aria-hidden="true"
